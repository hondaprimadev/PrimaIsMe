...
export default function SalesArea() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: 'Simulasi Angsuran', statusBarColor: Colors.tint }} />
      <View style={styles.container}>
        <Text>PILIH TIPE</Text>
        <View style={{ borderColor: Colors.textSecondary, borderRadius: 5, borderWidth: 1, marginBottom: 20 }}>
          <RNPickerSelect
        ...
        <Text style={{ fontSize: 18, textAlign: "center" }}>NOMINAL ANGSURAN</Text>
        <View style={{ borderColor: Colors.tint, borderWidth: 2, borderRadius: 5, padding: 5, width: "70%", alignSelf: "center", alignItems: "center" }}>
