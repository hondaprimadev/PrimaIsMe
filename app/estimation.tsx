...
export default function SalesArea() {
  ...
  return (
    <>
      <Stack.Screen options={{ title: 'Kalkulator Gaji', statusBarColor: Colors.tint }} />
      <Animated.ScrollView style={styles.container}>
        <View style={{ borderColor: Colors.textSecondary, borderRadius: 5, borderWidth: 1 }}>
          <RNPickerSelect
        ...
        <Text style={{ textAlign: "center", fontSize: 22, padding: 10, marginBottom: 20 }}>Yuk, kasih tahu berapa yang ingin kamu Jual! 😄</Text>
